...
Page({
  ...
  onLoad(options) {
    ...
    wx.request({
      url: 'https://ntx.qqtn.com/api/my/imageDecorateList',
      method: 'GET',
      data: {},
      success: function(res) {
        ...
        for (let i = 0; i < res.data.data.length; i++) {
          tempList[i] = res.data.data[i].name;
        }
        ...
        imgList = allData[that.data.leftindex].ico_arr
  ...
  leftClick: function(e) {
    ...
    imgList = allData[this.data.leftindex].ico_arr
